...
typeof ctx (Equals e1 e2) = case (typeof ctx e1, typeof ctx e2) of
                        ...
                        (Just TBool, Just TBool) -> Just TBool
                        _                        -> Nothing  
typeof ctx (NotEq e1 e2) = case (typeof ctx e1, typeof ctx e2) of
                        (Just TNum, Just TNum) -> Just TBool
                        (Just TBool, Just TBool) -> Just TBool
                        _                        -> Nothing         
...
typeof ctx (Smaller e1 e2) = case (typeof ctx e1, typeof ctx e2) of
                        (Just TNum, Just TNum) -> Just TBool
                        _                        -> Nothing       
typeof ctx (GreaterEq e1 e2) = case (typeof ctx e1, typeof ctx e2) of
                        (Just TNum, Just TNum) -> Just TBool
                        _                        -> Nothing              
typeof ctx (SmallerEq e1 e2) = case (typeof ctx e1, typeof ctx e2) of
                        (Just TNum, Just TNum) -> Just TBool
                        _                        -> Nothing                               
